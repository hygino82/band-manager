...
public class AlbumController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ResponseAlbumDto> update(@PathVariable Long id, @RequestBody RequestAlbumDto dto) {
        try {
            ResponseAlbumDto updatedAlbum = albumService.update(id, dto);
